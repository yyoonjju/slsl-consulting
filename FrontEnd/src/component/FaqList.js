...
const FaqList = () => {
  ...
  const faqs = [
    {
      question: (<>정부 보조금을 받으면 사업비가 얼마나 축소되나요?</>),
      answer: (
        <>
    ...
    },
    {
      ...
      answer: (
        <>
          어레이란 태양전지가 모여 만들어진 하나의 판(모듈)을 여러장 연결한 태양광 설비를 말합니다.
          
        </>
      ),
    },
    {
      question: (<>설치는 지붕이나 주차장 등 다양한 곳에 하고 싶은데 다 할 수 있나요?</>),
      answer: (
        <>
          공장지붕, 건물지붕, 축사지붕, 주차장 등
          모든 곳에 설치 가능하니 걱정하지 않으셔도 됩니다.
        </>
      ),
    },
    {
      question: (<>태양광 모듈의 설치 각도나 방향은 어떻게 해야하나요?</>),
      answer: (
        <>
